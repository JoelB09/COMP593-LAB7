...
def get_old_people():
    ...
    #Returns: list: (name, age) of old people 
...
def print_name_and_age(name_and_age_list):
    ...
    # Args: name_and_age_list (list): (name, age) of people
...
def save_name_and_age_to_csv(name_and_age_list, csv_path):
    ...
    #Args:name_and_age_list (list): (name, age) of people csv_path (str): Path of CSV file""
